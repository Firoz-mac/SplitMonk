...
const CreateSplit = () => {
  ...
  return (
    <div className='md:h-screen flex justify-center'>
        <div className='w-full max-w-md px-5 py-10 space-y-5 flex flex-col md:justify-center'>
            ...
            <button onClick={handleSubmit} disabled={isDisable} className='w-full bg-[var(--primary)] 
